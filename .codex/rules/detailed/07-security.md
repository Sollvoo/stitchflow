---
description: Securite - CSRF, secrets, validation fichiers, OWASP Top 10
...
- **Jamais faire confiance au nom de fichier utilisateur** - renommer avec UUID systematiquement
...
- Ne jamais exempter une vue sans raison documentee
...
- Telechargement via `FileResponse` avec `as_attachment=True`
- Verifier ownership avant download quand la vue est reservee a un utilisateur authentifie
