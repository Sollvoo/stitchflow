---
description: Vues Django - patterns HTMX, vues generiques, dispatch Celery
...
- **Jamais de logique metier dans les vues** - passer par `services/`
- **`get_object_or_404`** pour tous les acces par PK/UUID
- **`FileResponse`** pour servir les fichiers binaires (PES) avec `as_attachment=True`
- **Partials HTMX** : template_name separe dans `partials/`, retourner `TemplateResponse`
